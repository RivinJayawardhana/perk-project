    ...
    <>
      ...
      <section className="bg-[#1a2233] py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-[#e6b756] font-semibold text-center mb-2 font-display">Why partner with us</div>
          <h2 className="text-3xl font-bold text-white text-center mb-10 font-display">Benefits for your brand</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-[#232b3b] rounded-2xl p-8 flex flex-col items-start">
              ...
              <div className="text-lg font-semibold text-white mb-2 font-display">Reach Decision Makers</div>
            ...
            <div className="bg-[#232b3b] rounded-2xl p-8 flex flex-col items-start">
              ...
              <div className="text-lg font-semibold text-white mb-2 font-display">Drive Conversions</div>
            ...
            <div className="bg-[#232b3b] rounded-2xl p-8 flex flex-col items-start">
              ...
              <div className="text-lg font-semibold text-white mb-2 font-display">Build Brand Loyalty</div>
            ...
            <div className="bg-[#232b3b] rounded-2xl p-8 flex flex-col items-start">
              ...
              <div className="text-lg font-semibold text-white mb-2 font-display">Global Exposure</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <div key={item.step} className="flex flex-col items-center">
                <div className="w-14 h-14 rounded-full bg-[#e86a2a] text-white flex items-center justify-center text-xl font-bold mb-4 font-display">{item.step}</div>
                <div className="font-semibold text-[#23272f] mb-1 font-display">{item.title}</div>
      ...
      <section id="apply" className="py-20 bg-[#fcfaf7]">
        <div className="max-w-xl mx-auto">
          <div className="text-[#e6b756] font-semibold text-center mb-2 font-display">Get started</div>
          <h2 className="text-3xl font-bold text-[#23272f] text-center mb-2 font-display">Apply to become a partner</h2>
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-md p-8 flex flex-col gap-6">
            ...
            <Button type="submit" className="bg-[#e6b756] text-[#1a2233] font-semibold px-8 py-3 rounded-full hover:bg-[#f5d488] font-display" disabled={submitted}>
